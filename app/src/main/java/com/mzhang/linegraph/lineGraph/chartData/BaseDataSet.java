...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
     ...
     */
    protected PointFloat mIconsOffset = new PointFloat();
    ...
    public ValueFormatter getValueFormatter() {
        if (needsFormatter())
            return ChartUtils.getDefaultValueFormatter();
    ...
    public void setValueTextSize(float size) {
        mValueTextSize = ChartUtils.convertDpToPixel(size);
    }
    ...
    @Override
    public void setIconsOffset(PointFloat offsetDp) {
    ...
    @Override
    public PointFloat getIconsOffset() {
        return mIconsOffset;
    }
