...
import com.mzhang.linegraph.lineGraph.labelFormatters.DefaultAxisValueFormatter;
...
//    protected List<LimitLine> mLimitLines;
    ...
    public AxisBase() {
        ...
        this.mYOffset = ChartUtils.convertDpToPixel(5f);
    }
    ...
    public void setAxisLineWidth(float width) {
        mAxisLineWidth = ChartUtils.convertDpToPixel(width);
    }
