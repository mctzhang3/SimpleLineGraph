...
/**
 * This class encapsulates everything both Axis, Legend have in common.
 *
 */
public abstract class ComponentBase {
     ...
     */
    protected float mTextSize = ChartUtils.convertDpToPixel(10f);
    ...
    public void setXOffset(float xOffset) {
        mXOffset = ChartUtils.convertDpToPixel(xOffset);
    }
    ...
    public void setYOffset(float yOffset) {
        mYOffset = ChartUtils.convertDpToPixel(yOffset);
    }
    ...
    public void setTextSize(float size) {
        ...
        mTextSize = ChartUtils.convertDpToPixel(size);
    }
