...
public class ChartDimens {
    ...
    public PointFloat getContentCenter() {
        return PointFloat.getInstance(mContentRect.centerX(), mContentRect.centerY());
    }
    ...
    public void setDragOffsetX(float offset) {
        mTransOffsetX = ChartUtils.convertDpToPixel(offset);
    }
    ...
    public void setDragOffsetY(float offset) {
        mTransOffsetY = ChartUtils.convertDpToPixel(offset);
    }
