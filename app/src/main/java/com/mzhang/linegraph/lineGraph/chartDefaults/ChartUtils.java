...
public abstract class ChartUtils {
     ...
     * @return
     */
    public static PointFloat getPosition(PointFloat center, float dist, float angle) {

        PointFloat p = PointFloat.getInstance(0,0);
        getPosition(center, dist, angle, p);
        return p;
    }

    public static void getPosition(PointFloat center, float dist, float angle, PointFloat outputPoint){
    ...
    public static void drawImage(Canvas canvas,
        ...
        PointFloat drawOffset = PointFloat.getInstance();
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
                                      Paint paint,
                                      PointFloat anchor, float angleDegrees) {
